					...
					<div className="w-full h-fit grid grid-flow-row md:grid-cols-2 gap-x-4 gap-y-8 md:gap-8 px-4 sm:px-8 lg:px-16">
						<div>
							...
							<div className="mt-1 text-sm sm:text-base grid grid-cols-1 sm:grid-cols-2 gap-2">
								...
								{data?.links?.tiktok && (
									<Link href={data.links.tiktok} className="underline underline-offset-2 hover:text-primary truncate">
										<SvgSocial1 className="inline me-2" />
										{data.links.tiktok}
									</Link>
								)}
								{data?.links?.facebook && (
									<Link href={data.links.facebook} className="underline underline-offset-2 hover:text-primary truncate">
										<SvgSocial2 className="inline me-2" />
										{data.links.facebook}
									</Link>
								)}
								{data?.links?.youtube && (
									<Link href={data.links.youtube} className="underline underline-offset-2 hover:text-primary truncate">
										<SvgSocial3 className="inline me-2" />
										{data.links.youtube}
									</Link>
								)}
								{data?.links?.website && (
									<Link href={data.links.website} className="underline underline-offset-2 hover:text-primary truncate">
